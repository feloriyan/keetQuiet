...
import com.example.voicetranscriber.databinding.ActivityMainBinding
import com.example.voicetranscriber.ui.HistoryFragment
import com.example.voicetranscriber.ui.RecentFragment
import com.example.voicetranscriber.ui.SettingsBottomSheet
...
class MainActivity : AppCompatActivity() {
    ...
    @javax.inject.Inject
    lateinit var transcriptionManager: com.example.voicetranscriber.model.TranscriptionManager
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.transcriptionState.collect { state ->
                    when (state) {
                        is com.example.voicetranscriber.model.TranscriptionState.DownloadingModels -> {
                            showDownloadDialog(state.progress)
                        }
                        is com.example.voicetranscriber.model.TranscriptionState.Idle,
                        is com.example.voicetranscriber.model.TranscriptionState.WaitingForModel,
                        is com.example.voicetranscriber.model.TranscriptionState.Transcribing -> {
                            hideDownloadDialog()
                        }
                        is com.example.voicetranscriber.model.TranscriptionState.Error -> {
                            hideDownloadDialog()
