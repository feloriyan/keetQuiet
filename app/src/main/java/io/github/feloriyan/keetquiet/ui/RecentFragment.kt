...
import io.github.feloriyan.keetquiet.databinding.FragmentRecentBinding
...
class RecentFragment : Fragment() {
    ...
    private fun showTranscriptionResult(transcription: io.github.feloriyan.keetquiet.data.Transcription) {
